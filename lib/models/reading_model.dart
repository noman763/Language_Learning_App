class ReadingPassage {
  ...
  ReadingPassage({required this.text, required this.translation});
}

final Map<String, List<ReadingPassage>> readingData = {
  'English': [
    ReadingPassage(
